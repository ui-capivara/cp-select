...
var ComponentInstance = /** @class */ (function () {
    ...
    ComponentInstance.prototype.build = function () {
        ...
        if (_common__WEBPACK_IMPORTED_MODULE_2__["Common"].getScope(this.element).scope.$ctrl.$onBuild) {
            _common__WEBPACK_IMPORTED_MODULE_2__["Common"].getScope(this.element).scope.$ctrl.$onBuild();
        }
    };
    /**
    ...
    */
    ...
    ComponentInstance.prototype.applyFunctionsComponentMagic = function () {
        var _this = this;
        if (!_common__WEBPACK_IMPORTED_MODULE_2__["Common"].getScope(this.element).scope[this.config.controllerAs]['$functions']) {
            lodash__WEBPACK_IMPORTED_MODULE_0__["set"](_common__WEBPACK_IMPORTED_MODULE_2__["Common"].getScope(this.element).scope, this.config.controllerAs + '.$functions', {});
            lodash__WEBPACK_IMPORTED_MODULE_0__["set"](_common__WEBPACK_IMPORTED_MODULE_2__["Common"].getScope(this.element).scope, '$functions', {});
        }
...
var CPClick = /** @class */ (function () {
    function CPClick(_element, _map) {
        ...
        if (!this.attribute) {
            this.attribute = this.element.getAttribute(_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].DBLCLICK_ATTRIBUTE_NAME);
...
var CPRepeat = /** @class */ (function () {
    ...
    CPRepeat.prototype.loop = function (array, attributeAlias) {
        ...
        this.elms.reverse().forEach(function (elm, index) {
...
var MapDom = /** @class */ (function () {
    ...
    MapDom.prototype.createCPClick = function (child) {
        this.directives.cpClicks.push(new _directive_cp_click__WEBPACK_IMPORTED_MODULE_6__["CPClick"](child, this));
    };
    /**
     *
    ...
    MapDom.prototype.createCPIf = function (child) {
        this.directives.cpIfs.push(new _directive_cp_if__WEBPACK_IMPORTED_MODULE_12__["CPIf"](child, this));
    };
    /**
     *
    ...
    MapDom.prototype.createCPElse = function (child) {
        this.directives.cpElses.push(new _directive_cp_else__WEBPACK_IMPORTED_MODULE_8__["CPElse"](child, this));
    };
    /**
     *
    ...
    MapDom.prototype.createCPElseIf = function (child) {
        this.directives.cpElseIfs.push(new _directive_cp_else_if__WEBPACK_IMPORTED_MODULE_9__["CPElseIf"](child, this));
    };
    /**
     *
    ...
    MapDom.prototype.createCPInit = function (child) {
        this.directives.cpInits.push(new _directive_cp_init__WEBPACK_IMPORTED_MODULE_13__["CPInit"](child, this));
    };
    /**
     *
    ...
    MapDom.prototype.createCPStyle = function (child) {
        this.directives.cpStyles.push(new _directive_cp_style__WEBPACK_IMPORTED_MODULE_19__["CPStyle"](child, this));
    };
    /**
     *
    ...
    MapDom.prototype.createCPClass = function (child) {
        this.directives.cpClasses.push(new _directive_cp_class__WEBPACK_IMPORTED_MODULE_5__["CPClass"](child, this));
    };
    /**
     *
    ...
    MapDom.prototype.createCPKey = function (child) {
        this.directives.cpKeys.push(new _directive_cp_key__WEBPACK_IMPORTED_MODULE_14__["CPKey"](child, this));
    };
    /**
     * @param child Elemento que está criando a bind do attr.
     */
    MapDom.prototype.createCPAttr = function (child) {
        this.directives.cpAttrs.push(new _directive_cp_attr__WEBPACK_IMPORTED_MODULE_2__["CPAttr"](child, this));
    };
    /**
     * @param child Elemento que está sendo criado o bind do disable.
     */
    MapDom.prototype.createCPDisabled = function (child) {
        this.directives.cpDisables.push(new _directive_cp_disabled__WEBPACK_IMPORTED_MODULE_7__["CPDisabled"](child, this));
    };
    /**
     * @param child Elemento que está sendo criado o bind do focus.
     */
    MapDom.prototype.createCPFocus = function (child) {
        this.directives.cpFocus.push(new _directive_cp_focus__WEBPACK_IMPORTED_MODULE_10__["CPFocus"](child, this));
    };
    /**
     * @param child Elemento que está sendo criado o bind do hide.
     */
    MapDom.prototype.createCPHide = function (child) {
        this.directives.cpHide.push(new _directive_cp_hide__WEBPACK_IMPORTED_MODULE_11__["CPHide"](child, this));
    };
    /**
     * @param child Elemento que está sendo criado o bind do blur.
     */
    MapDom.prototype.createCPBlur = function (child) {
        this.directives.cpBlur.push(new _directive_cp_blur__WEBPACK_IMPORTED_MODULE_3__["CPBlur"](child, this));
    };
    /**
    * @param child Elemento que está sendo criado o bind do dbTitle.
    */
    MapDom.prototype.createCPmouse = function (child) {
        this.directives.cpMouse.push(new _directive_cp_mouse__WEBPACK_IMPORTED_MODULE_16__["CPMouse"](child, this));
    };
    /**
    * @param child Elemento que está sendo criado o bind do placeholder.
    */
    MapDom.prototype.createCPChange = function (child) {
        this.directives.cpChange.push(new _directive_cp_change__WEBPACK_IMPORTED_MODULE_4__["CPChange"](child, this));
    };
    return MapDom;
}());
...
/***/ "../src/helpers/focus-element.ts":
/*!***************************************!*\
  !*** ../src/helpers/focus-element.ts ***!
  \***************************************/
/*! exports provided: FocusElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
(function (FocusElement) {
    var ITEMS_QUERY = 'ul li.binding-repeat';
    var ITEMS_FOCUSED_KEY = 'focused';
    function getOptions(element) {
        return Array.from(element.querySelectorAll(ITEMS_QUERY) || []);
    }
    FocusElement.getOptions = getOptions;
    function getFirstOption(element) {
        return element.querySelector(ITEMS_QUERY + ':first-child');
    }
    FocusElement.getFirstOption = getFirstOption;
    function getLastOption(element) {
        return element.querySelector(ITEMS_QUERY + ':last-child');
    }
    FocusElement.getLastOption = getLastOption;
    function setFocusedFirstElement(element) {
        setFocused(getFirstOption(element));
    }
    FocusElement.setFocusedFirstElement = setFocusedFirstElement;
    function setFocusedLastElement(element) {
        setFocused(getLastOption(element));
    }
    FocusElement.setFocusedLastElement = setFocusedLastElement;
    function getOptionFocused(element) {
        return element.querySelector(ITEMS_QUERY + '.' + ITEMS_FOCUSED_KEY);
    }
    FocusElement.getOptionFocused = getOptionFocused;
    function removeAllFocus(element) {
        getOptions(element).forEach(function (option) { return option.classList.remove(ITEMS_FOCUSED_KEY); });
    }
    FocusElement.removeAllFocus = removeAllFocus;
    function setFocused(option) {
        if (option) {
            option.classList.add(ITEMS_FOCUSED_KEY);
        }
    }
    FocusElement.setFocused = setFocused;
    function setScrollInOptionFocused(element) {
        var liFocused = getOptionFocused(element);
        if (liFocused) {
    ...
    FocusElement.setScrollInOptionFocused = setScrollInOptionFocused;
    function down(element, evt) {
        var lastFocused = getOptionFocused(element);
    ...
    FocusElement.down = down;
    function up(element, evt) {
        var lastFocused = getOptionFocused(element);
        this.removeAllFocus(element);
    ...
    FocusElement.handling = handling;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _coordinates__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./coordinates */ "../src/helpers/coordinates.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Coordinates", function() { return _coordinates__WEBPACK_IMPORTED_MODULE_0__["Coordinates"]; });
...
/* harmony import */ var _select_select_style_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_select_select_style_scss__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _select_select_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./select/select.component */ "../src/select/select.component.ts");
...
/*!*****************************************!*\
  !*** ../src/select/select.component.ts ***!
  \*****************************************/
/*! exports provided: SelectController */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SelectController = /** @class */ (function () {
    ...
    SelectController.prototype.onKeyDown = function (evt) {
        if (evt.keyCode == 13) {
            evt.preventDefault();
            evt.stopPropagation();
            var focusedOption = _helpers_focus_element__WEBPACK_IMPORTED_MODULE_2__["FocusElement"].getOptionFocused(this.$element);
            if (focusedOption) {
                this.select(focusedOption['$scope'].scope.$value);
            }
        }
        else {
            _helpers_focus_element__WEBPACK_IMPORTED_MODULE_2__["FocusElement"].handling(this.$element, evt);
        }
    };
    SelectController.prototype.onKeyUp = function (evt) {
        evt.preventDefault();
        evt.stopPropagation();
    ...
    SelectController.prototype.$onInit = function () {
        ...
        this.$scope.element(document).on('scroll', function () {
            if (_this.hasFocus) {
                _this.setStyleList();
            }
        });
    ...
    SelectController.prototype.$onViewInit = function () {
        ...
        this.$scope.$watch('$ctrl.$bindings.cpModel', function (newValue) { return _this.select(newValue, true); });
    };
    SelectController.prototype.closeWhenClickAway = function () {
        var _this = this;
        this.$scope.element(document.body).on('click', function (evt) {
            var elm = evt.target, clickedTheComponent = false;
            while (elm) {
    ...
    SelectController.prototype.select = function ($value, forceUpdate) {
        if (($value && !capivarajs__WEBPACK_IMPORTED_MODULE_0___default.a.equals($value, this.$bindings.cpModel)) || ($value && forceUpdate)) {
    ...
    SelectController.prototype.load = function (param, debounce, clearModel) {
        ...
        this.timeLastSearch = setTimeout(function () {
            if (_this.$bindings.cpModel) {
                return;
            }
            ;
            _this.loading = true;
            _this.getDataAsync(param).then(function (resp) {
                _this.data = resp;
                if (_this.hasFocus) {
                    _this.open();
                    setTimeout(function () {
                        _helpers_focus_element__WEBPACK_IMPORTED_MODULE_2__["FocusElement"].removeAllFocus(_this.$element);
                        _helpers_focus_element__WEBPACK_IMPORTED_MODULE_2__["FocusElement"].setFocusedFirstElement(_this.$element);
                    }, 100);
                }
                _this.loading = false;
            });
    ...
    SelectController.prototype.getDataAsync = function (param) {
        var _this = this;
        if (param === void 0) { param = ''; }
        return new Promise(function (resolve, reject) {
            var data = Array.isArray(_this.$bindings.items) ? _this.$bindings.items : _this.$bindings.items(param);
            ...
            if (typeof data.then === 'function') {
                data.then(function (itemsResponse) {
    ...
    SelectController.prototype.setStyleList = function () {
        var position = _helpers__WEBPACK_IMPORTED_MODULE_1__["Coordinates"].get(this.containerElement);
        var obj = {
            'position': 'fixed',
    ...
    SelectController.prototype.getText = function ($value) {
        return this.$constants.field ? $value[this.$constants.field] : $value;
    };
    SelectController.prototype.hasTransclude = function () {
        return this.$element.querySelector('cp-transclude');
    };
    SelectController.prototype.setFavoriteKey = function () {
    ...
    SelectController.prototype.favorite = function (evt, $value) {
        if (this.timeCloseList) {
            clearTimeout(this.timeCloseList);
        }
        evt.preventDefault();
        ...
        if (this.isFavorite($value)) {
            _helpers_cookie__WEBPACK_IMPORTED_MODULE_3__["Cookie"].erase(this.FAVORITE_KEY);
        }
        else {
            _helpers_cookie__WEBPACK_IMPORTED_MODULE_3__["Cookie"].set(this.FAVORITE_KEY, $value);
        }
        this.hasFocus = true;
        this.containerElement.querySelector('input').focus();
    };
    SelectController.prototype.isFavorite = function ($value) {
        return _helpers_cookie__WEBPACK_IMPORTED_MODULE_3__["Cookie"].isFavorite(this.FAVORITE_KEY, $value);
    };
    SelectController.prototype.$onChanges = function () {
        var _this = this;
        setTimeout(function () {
            if (_this.$bindings.cpModel) {
                _this.inputValue = _this.$constants.field ? _this.$bindings.cpModel[_this.$constants.field] : _this.$bindings.cpModel;
            }
        });
    };
...
/***/ "../src/select/select.template.html":
/*!******************************************!*\
  !*** ../src/select/select.template.html ***!
  \******************************************/
/*! no static exports found */
